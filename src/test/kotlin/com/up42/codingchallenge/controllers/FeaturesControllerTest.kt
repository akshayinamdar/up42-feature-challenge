...
class FeaturesControllerTest {
    ...
    @Test
    fun `return http 400 for invalid feature`() {
        given()
            .get("/features/invalid/quicklook")
            .then()
            .statusCode(400)
    }

    @Test
    fun `return http 200 and image for valid feature`() {
        given()
    ...
    @Test
    fun `return http 200 for valid feature id`() {
        given()
            .get("/features/7f23a853-76a8-4787-a2ba-fdfe93e74165/quicklook")
            .then()
            .statusCode(200)
